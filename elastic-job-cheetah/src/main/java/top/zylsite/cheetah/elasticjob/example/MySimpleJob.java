...
@ElasticJob(name = "MySimpleJob", cron = "0/10 * * * * ?", shardingItemParameters = "0=0,1=1", description = "简单任务", eventTraceRdbDataSource = "datasource")
	...
	public void execute(ShardingContext context) {
		...
		for (int i = 0; i < 1; i++) {
			if (i % 2 == value) {
				...
				System.out.println(time + ":[MySimpleJob]开始执行简单任务" + i);
			}
		}
	}
